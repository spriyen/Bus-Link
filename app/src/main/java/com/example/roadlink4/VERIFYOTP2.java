                                ...
                                .addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                                    ...
                                    public void onComplete(@NonNull Task<AuthResult> task) {
                                        ...
                                        if(task.isSuccessful()){
                                            ...
                                            Toast.makeText(VERIFYOTP2.this,"incorrect OTP",Toast.LENGTH_SHORT).show();
                                        }
                                    }
                                });
                    }else {
                        Toast.makeText(VERIFYOTP2.this,"Please check the connection",Toast.LENGTH_SHORT).show();
                    }
               ...
               PhoneAuthProvider.getInstance().verifyPhoneNumber(
                       ...
                       new PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
                           ...
                           public void onCodeSent(@NonNull String newbackendotp, @NonNull PhoneAuthProvider.ForceResendingToken forceResendingToken) {
                              ...
                              Toast.makeText(VERIFYOTP2.this,"otp sent succesfully" ,Toast.LENGTH_SHORT).show();
                           }
                       }
